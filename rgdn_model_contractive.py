...
* pointwise orthogonal channel mixing has norm one;
* learned depthwise filters are normalized to l1 norm at most one;
...
class CertifiedDepthwiseConv2d(nn.Module):
    ...
    norm to at most ``target`` is valid for every spatial image size.
    """
...
class SigmaConditionedNonexpansiveBlock(nn.Module):
    ...
    def __init__(
        ...
        self.spatial_1 = CertifiedDepthwiseConv2d(channels)
        self.spatial_2 = CertifiedDepthwiseConv2d(channels)
...
class ContractiveRGDN(nn.Module):
    ...
    def __init__(
        ...
        self.tail_spatial = CertifiedDepthwiseConv2d(in_channels)
    ...
    def certificate(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "all_certified_layers_nonexpansive": bool(maximum <= 1.0 + 1.0e-6),
        }
